...
ANOMALY_SUBCATEGORIES: dict[int, list[str]] = {
    1: [],                                      # 正常
    2: ["water_stain", "pigment_stain"],        # 污渍
    3: ["scratch", "crack"],                    # 本体损坏
    4: ["colorless_liquid", "colored_clear_liquid", "turbid_liquid", "wall_liquid_residue"],  # 液体残留
    5: ["powder", "crystalline_residue"],       # 固体残留
    6: ["cracked_lid", "incorrect_lid", "missing_lid"],  # 盖子异常
    7: ["label_soiling", "label_detachment", "label_damage"],  # 标签异常
    8: ["tilted_placement"], # 摆放异常
}
